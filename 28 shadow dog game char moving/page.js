...
const enemyArr = [];
let enemy1Img = null, enemy2Img = null, enemy3Img = null, enemy4Img = null;
let frameCount = 0;
...
await Promise.resolve(loadImage("./images/enemy4.png"))
.then(image => {
    enemy4Img = image;
});
...
function init() {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        enemyArr.push(new Enemy(ctx, x, y, 213, 213, enemy4Img, 9, dx, dy, 1));
    }
